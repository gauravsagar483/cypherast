...
from cypherglot.dialects.constraints import (
    ConstraintIssue,
    raise_if_invalid,
    validate_capabilities,
)
from cypherglot.lexer import Lexer
...
class Dialect:
    ...
    def constraint_rule_set(cls) -> RuleSet:
        ...
        from cypherglot.optimizer import constraint_rules
    ...
    def apply_constraints(
        ...
        *,
        ...
        from cypherglot.optimizer import resolve_rules
    ...
    def optimize(
        ...
        *,
        ...
        from cypherglot.optimizer import RULES
...
def get_dialect(name: str | None = None) -> Dialect:
    ...
    if key not in _REGISTRY:
        import cypherglot.dialects  # noqa: F401
    if key not in _REGISTRY:
