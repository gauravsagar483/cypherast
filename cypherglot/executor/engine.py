...
from cypherglot.errors import ExecuteError
from cypherglot.executor.env import NULL, Env, cypher_true, eval_expr, is_null
        ...
        def add(rel: Relationship, other_id: int) -> None:
            ...
            if isinstance(pat.properties, a.Map):
                for k, vexpr in pat.properties.entries:
                    ...
                    from cypherglot.executor.env import Env as _E
