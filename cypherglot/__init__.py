"""cypherglot — Cypher/GQL transpiler, rewriter, planner, executor."""

from __future__ import annotations

from cypherglot import ast
from cypherglot.dialects import dialect_names, get_dialect
from cypherglot.errors import (
    CompatibilityError,
    CypherglotError,
    ExecuteError,
    OptimizeError,
...
from cypherglot.lexer import Lexer, Token, TokenKind
...
def optimize(
    ...
    *,
    ...
    """
    from cypherglot.dialects.dialect import get_dialect_cls
...
def translate(
    ...
    *,
    ...
    """
    from cypherglot.dialects.constraints import raise_if_invalid
    from cypherglot.dialects.dialect import get_dialect_cls
...
def explain(cypher: str, schema: object | None = None, read: str | None = None) -> str:
    ...
    from cypherglot.planner import explain as _explain
...
def profile(
    ...
    *,
    ...
    from cypherglot.planner import profile as _profile
...
def run(
    ...
    *,
    ...
    from cypherglot.executor import execute
    from cypherglot.executor.graph import Graph

    tree = parse_one(cypher, read=read)
    g = graph if isinstance(graph, Graph) or graph is None else None
    if graph is not None and not isinstance(graph, Graph):
        raise TypeError("graph must be a cypherglot.executor.Graph")
...
def lineage(
    ...
    *,
    ...
    from cypherglot.lineage import lineage as _lineage
