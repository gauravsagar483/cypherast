...
from cypherglot.optimizer.catalog import (
    ALL_CANONICAL_RULES,
    OPTIONAL_RULES,
    RULES,
    constraint_rules,
)
from cypherglot.optimizer.engine import Rule, RuleFn, RuleSet, resolve_rules, rule
...
def optimize(
    ...
    **kwargs: t.Any,
    ...
    Examples::
        ...
        from cypherglot.optimizer import RULES, optimize
