...
from cypherglot.errors import ValidationError
from cypherglot.scope import Scope, build_scope
...
<link rel="stylesheet" href="https://unpkg.com/vis-network/styles/vis-network.min.css"/>"""
        ...
        return f"""<div>
<div id="cypherglot-lineage"></div>
{imports}
<script>
new vis.Network(
  document.getElementById("cypherglot-lineage"),
